var fsBanner = function(container, options) {
	...
	this.setup = function() {
		...
		if(!this.container.parent().width()) this.container.width(this.container.parent().width());

		this.part = this.container.parent().width() / this.items.length;
		this.mini = this.part / 4;
		this.widmain = this.container.parent().width() - (this.mini * this.items.length - 1);
